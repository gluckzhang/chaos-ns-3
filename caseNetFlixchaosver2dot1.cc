...
public:
  ...
  void SetDownNode(Ptr<Node> node){
	...
	{     
				...
				p2pNodes6.Add(p2pNodes2.Get(1));
				p2pNodes6.Create(1);
				p2pNodes7.Add(p2pNodes4.Get(1));
				p2pNodes7.Create(1);
				p2pNodes8.Add(p2pNodes6.Get(1));
        ...
        MobilityHelper mobility;
			  ...
			  mobility.SetMobilityModel ("ns3::ConstantPositionMobilityModel");
				...
				anim.SetConstantPosition(allnodes.Get(4),r*cos(angle) + r,r*sin(angle));
				anim.SetConstantPosition(allnodes.Get(5),r*cos(angle) + r,0);
				anim.SetConstantPosition(allnodes.Get(6),r*cos(angle) + 2*r,0);
