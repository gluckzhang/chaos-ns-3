...
PointToPointNetDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PointToPointNetDevice")
    ...
    .AddTraceSource ("PromiscSniffer", 
                     ...
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("DataRateChange", 
                     "DataRate changed",
                     MakeTraceSourceAccessor (&PointToPointNetDevice::m_dataratetrace),
                     "ns3::PointToPointNetDevice::DataRateCallBack")
  ;
  return tid;
}
...
void
PointToPointNetDevice::NotifyDataRateChange (void)
{
  m_dataratetrace (this);
}


DataRate PointToPointNetDevice::GetBps() {
  return m_bps;
}
...
{
  NS_LOG_FUNCTION (this);
  if(bps.GetBitRate()!=m_bps.GetBitRate()){  
    m_bps = bps;
    NotifyDataRateChange();
  }
}
