...
public:
  Ptr<Object> dataOb=0;
  void SetDataOb(Ptr<Object> Ob){
    dataOb = Ob;
  }
  DataRate GetBps(void);
  TracedCallback<Ptr<PointToPointNetDevice> > m_dataratetrace;
  typedef void (* DataRateCallback)(Ptr<PointToPointNetDevice> netptr);
  void NotifyDataRateChange (void);
