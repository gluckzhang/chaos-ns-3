...
Object::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::Object")
    ...
    .SetGroupName ("Core")
    .AddTraceSource ("ObjectDestruction", 
                     "Object destroyed",
                     MakeTraceSourceAccessor (&Object::m_objectdestroytrace),
                     "ns3::Object::ObjectDestroyCallBack")
  ;
  return tid;
}

void
Object::NotifyObjectDestroyed (void)
{
  m_objectdestroytrace (this);
}
